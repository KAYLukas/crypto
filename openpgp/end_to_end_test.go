...
func encryptDecryptTest(t *testing.T, testSetFrom algorithmSet, testSetTo algorithmSet, privateKeyFrom EntityList, publicKeyTo EntityList, privateKeyTo EntityList) {
			...
			for _, testSetTo := range testSets {
				t.Run(testSetTo.name,
					func(t *testing.T) {
						...
						encryptDecryptTest(t, testSet, testSetTo, privateKeyFrom, publicKeyTo, privateKeyTo)
					})
			}
		})
	}
